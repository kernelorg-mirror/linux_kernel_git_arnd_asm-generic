...
asmlinkage long sys_pread5(unsigned int fd, char __user *buf, size_t count, SC_DECL64(pos));
asmlinkage long sys_pread6(unsigned int fd, char __user *buf, size_t count, int unused, SC_DECL64(pos));
asmlinkage long sys_pwrite64(unsigned int fd, const char __user *buf, size_t count, loff_t pos);
asmlinkage long sys_pwrite5(unsigned int fd, const char __user *buf, size_t count, SC_DECL64(pos));
asmlinkage long sys_pwrite6(unsigned int fd, const char __user *buf, size_t count, int unused, SC_DECL64(pos));
asmlinkage long sys_preadv(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, loff_t pos);
asmlinkage long sys_pwritev(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, loff_t pos);
asmlinkage long sys_preadv5(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, u32 pos_l, u32 pos_h);
asmlinkage long sys_pwritev5(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, u32 pos_l, u32 pos_h);
...
asmlinkage long sys_sync_file_range2(int fd, unsigned int flags, SC_DECL64(offset), SC_DECL64(nbytes));
asmlinkage long sys_sync_file_range6(int fd, SC_DECL64(offset), SC_DECL64(nbytes), unsigned int flags);
...
asmlinkage long sys_fadvise64_64_6(int fd, SC_DECL64(offset), SC_DECL64(len), int advice);
asmlinkage long sys_fadvise64_64_2(int fd, int advice, SC_DECL64(offset), SC_DECL64(len));
...
asmlinkage long sys_fanotify_mark6(int fanotify_fd, unsigned int flags, SC_DECL64(mask), int dfd, const char  __user * pathname);
...
asmlinkage long sys_preadv2(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, loff_t pos, unsigned long unused, rwf_t flags);
asmlinkage long sys_pwritev2(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, loff_t pos, unsigned long unused, rwf_t flags);
asmlinkage long sys_preadv6(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, u32 pos_l, u32 pos_h, rwf_t flags);
asmlinkage long sys_pwritev6(unsigned long fd, const struct iovec __user *vec, unsigned long vlen, u32 pos_l, u32 pos_h, rwf_t flags);
...
asmlinkage long sys_fadvise64_5(int fd, SC_DECL64(offset), size_t len, int advice);
asmlinkage long sys_fadvise64_6(int fd, int unused, SC_DECL64(offset), size_t len, int advice);
