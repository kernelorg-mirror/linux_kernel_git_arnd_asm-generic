...
__SCC(common, lookup_dcookie, sys_lookup_dcookie, compat_sys_lookup_dcookie)
...
__SC(common, nfsservctl, sys_ni_syscall)

/* fs/open.c */
#define __NR3264_statfs 43
__SCC(32, statfs64, sys_statfs64, compat_sys_statfs64)
__SC(64, statfs, compat_sys_statfs)
...
/* mm/, CONFIG_MMU only */
#if !defined(__ARCH_NOMMU) || defined(__GEN_SYSCALL_TBL)
...
__SC(32, io_pgetevents_time64, sys_io_pgetevents)
...
#if defined(__ARCH_WANT_SYS_CLONE3) || defined(__GEN_SYSCALL_TBL)
